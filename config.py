...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.TRAIN_DIR_LABEL = ''
        self._C.TRAINING.TRAIN_DIR_UNLABEL = ''
        self._C.TRAINING.VAL_DIR = ''
        self._C.TRAINING.TRAIN_UNALIGN_DIR = ''
        self._C.TRAINING.SAVE_DIR = 'checkpoints'
        self._C.TRAINING.TRAIN_PS = 1 
        self._C.TRAINING.VAL_PS = 1 
        self._C.TRAINING.CONSISTENCY = 1
        self._C.TRAINING.CONSISTENCY_RAMPUP = 7.0
